    ...
    String savePath = request.getSession().getServletContext().getRealPath("/source") + "/kingediter/attached/";   
    //文件保存目录URL /kindeditor/attached/  
    String saveUrl = request.getContextPath() + "/source/kingediter/attached/";   
    //定义允许上传的文件扩展名   
    //定义允许上传的文件扩展名   
